...
Additionally the fastq/a files at each stage are checked with [SeqKit Stats]() and [FastQC](https://github.com/s-andrews/FastQC) and a combined report generated by [MultiQC](https://github.com/MultiQC/MultiQC).
